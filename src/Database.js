...
for (let index = 0; index < 300; index++) {
    ...
    Schedules[index] = {
        ...
        stationNumber: Stations[casual.integer(0, Groups.length * roles.length - 1)].stationNumber,
        in: _in,
        out: _out,
    }
}
...
fs.writeFile("tempDatabase.js", JSON.stringify(database, null, 2), function(err) {
    if(err) {
